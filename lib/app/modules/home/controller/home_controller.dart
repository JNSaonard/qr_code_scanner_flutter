  ...
  Future<Map<String, dynamic>> getProductById(String codeBarang) async {
    try {
      ...
      if (hasil.docs.isEmpty) {
        return {
          "error": true,
          "message": "There is no this product in the database.",
        };
      }
      ...
      return {
        "error": false,
        "message": "Successfully got product details from this product code.",
        "data": ProductModel.fromJson(data),
      };
    } catch (e) {
      return {
        "error": true,
        "message": "Can't get product details from this product code.",
      };
    }
  }
}